  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-1.5 px-2 py-1.5 text-sm rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors"
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 z-50 bg-white border border-gray-200 rounded-xl shadow-lg py-1 min-w-[180px] max-h-[320px] overflow-y-auto">
